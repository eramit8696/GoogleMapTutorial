...
public class Event {
     ...
     * @param eventLatitude is the number of people who felt the earthquake and reported how
     *                         strong it was
     * @param eventLongitude is the perceived strength of the earthquake from the responses
     */
    public Event(String eventTitle, String eventLatitude, String eventLongitude) {
        title = eventTitle;
