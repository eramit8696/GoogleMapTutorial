...
import com.devidarshan.android.gpstracker.data.LocationContract;
...
public final class Utils {
    ...
    private static Event extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONArray featureArray = baseJsonResponse.getJSONArray("snappedPoints");

            // If there are results in the features array
            if (featureArray.length() > 0) {
                // Extract out the first feature (which is an earthquake)
                JSONObject firstFeature = featureArray.getJSONObject(0);
                JSONObject properties = firstFeature.getJSONObject("location");
                ...
                Log.e(LOG_TAG, "Latitude,Longitude "+latitude+","+longitude);
                  // Create a new {@link Event} object
                return new Event(title, latitude, longitude);
            }
